      ...
      <BrowserRouter>
        <Routes>
          <Route path='/' element={<LayoutClient/>}>
            ...
            <Route path='codeco' element={<CodecoPageDateil id={1}/>}/>
            <Route path='codeco' element={<CodecoPageDateil id={2}/>}/>
            <Route path='codeco' element={<CodecoPageDateil id={3}/>}/>
            <Route path='codeco' element={<CodecoPageDateil id={4}/>}/>
