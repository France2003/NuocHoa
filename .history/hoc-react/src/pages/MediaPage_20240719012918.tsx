...
const MediaPage = () => {
  return (
    <div className="container_Brand w-[1210px] mt-36 mb-8 m-auto flex flex-wrap justify-between gap-5 ">
      ...
      <Link to={'/tyna'}><MediaProc img={img4} title="TOP CÁC LOẠI TINH DẦU NƯỚC HOA CHO NGÀY HÈ NĂNG ĐỘNG" content="Tinh dầu nước hoa Matcha Chilling Day..." /> </Link>
      <Link to={'/thuyni'}><MediaProc img={img6} title="TOP 3 TINH DẦU NƯỚC HOA CODEDECO VỚI MÙI HƯƠNG SEXY" content="Codedeco sứ mệnh đem lại cho khách hàng những mùi hương quyến rũ và thanh lịch..." /></Link>
    </div>
  )
}
