        ...
        <div className='containerHome'>
            ...
            <div className='codedeco w-full flex items-center justify-around gap-[5px]'>
                ...
                <div className='w-[650px] '>
                    <p className='text-center inline text-[27.36px] font-[900]'>CODEDECO</p>
                    <p className='text-center inline text-[21.28px font-[900] tracking-wide'>CÂU CHUYỆN THƯƠNG HIỆU</p>
