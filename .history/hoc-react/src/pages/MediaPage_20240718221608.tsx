...
const MediaPage = () => {
  return (
    <div className="container_Brand w-[1210px] mt-36 mb-8 m-auto flex flex-wrap justify-between gap-5 ">
        <Link to={'media/giahan'}><MediaProc img={img1} title="Cách xịt nước hoa đúng cách và 3 vị trí xịt thơm lâu nhất " content="Những sai lầm thường gặp khi sử dụng nước hoa có thể bạn chưa biết..." /></Link>
