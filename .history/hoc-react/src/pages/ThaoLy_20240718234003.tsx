    ...
    <div className="mt-32 mb-5  w-[1120px]  flex justify-around flex-col  m-auto leading-7">
      ...
      <div className='mx-9 mt-5 m'>
        ...
        <div className='flex w-[1200px] gap-3 flex-wrap'>
          ...
          <div className='w-[450px] mx-2 absolute my-[4050px]'>
            <div>
            ...
            <div>
              <p>CODEDECO VIETNAM</p>
              <ul>
                <li>Website: </li>
                <li>Facebook: https://www.facebook.com/profile.php?id=61555159087139</li>
                <li>Instagram: @codedeco.official</li>
                <li>Shopee: https://shopee.vn/codedeco.official</li>
                <li>Hotline: 0967.077.882 – CSKH : 0383.226.567</li>
              </ul>
            </div>
          </div>
