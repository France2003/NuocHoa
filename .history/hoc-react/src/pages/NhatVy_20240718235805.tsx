...
const NhatVy = () => {
    return (
        <div className="mt-32 mb-5  w-[1120px]  flex justify-around flex-col  m-auto leading-7">
            ...
            <div>
                <p className='text-[19px] font-[600] mb-2'>Lý Do Nước Hoa Unisex Codedeco Được Yêu Thích</p>
                <div>
                    <p>Healing Hương Thơm Tự Nhiên</p>
                    <p>Nước hoa unisex của Cocodeco được chế tác từ những thành phần tự nhiên cao cấp, 
                    ...
                    <img src={img5I} className='w-[350px] h-[350px]' alt="" />
                </div>
                <div>
                    ...
                    <img src={img5II} className='w-[350px] h-[350px]' alt="" />
                </div>
                <div>
                    <p>Độ Lưu Hương Lâu Dài</p>
                    ...
                    <img src={img5III} className='w-[350px] h-[350px]' alt="" />
                </div>
            </div>
            <div>
                <p>Cách Sử Dụng Nước Hoa Unisex Hiệu Quả	</p>
                ...
                <img src={img5IV} className='w-[350px] h-[350px]' alt="" /> 
            </div>
            <div>
                <p>Mua Nước Hoa Unisex Cocodeco Ở Đâu?</p>
                ...
                <img src={img5V} className='w-[350px] h-[350px]' alt="" /> 
            </div>
        </div>
    )
}
