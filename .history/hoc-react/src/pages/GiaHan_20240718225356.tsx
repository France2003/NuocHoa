...
const GiaHan = () => {
    return (
        <div className='mt-32 w-[1120px]  flex justify-around flex-col  m-auto leading-7 '>
            <p className='text-[#333] text-[15px] uppercase font-[500] tracking-wider mb-2'>Lê Trần Gia Hân</p>
            <h1 className='uppercase text-[#383838] text-[27px] font-[600] mb-5'>Cách xịt nước hoa đúng cách và 3 vị trí xịt thơm lâu nhất  </h1>
            <img className="w-[1050px] h-[550px] m-auto" src={img1} alt="" />
            <ul className='I'>
