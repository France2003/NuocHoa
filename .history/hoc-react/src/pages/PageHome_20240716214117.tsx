...
const PageHome = () => {
    return (
        <div className='containerHome'>
            ...
            <div className='codedeco w-full flex items-center justify-center gap-[15px]'>
                <div>
                    <img src="https://codedeco.art/wp-content/uploads/2023/05/DSC_9623-1536x1022.jpg" alt="" width={352} height={234} />
                </div>
                <div className='w-[709px]'>
                    <h2 className='text-center'>CODEDECO</h2>
                    <h3 className='text-center'>CÂU CHUYỆN THƯƠNG HIỆU</h3>
                    <p className='text-center'>Tạo dựng thương hiệu tinh dầu chất lượng với giá thành hợp lý,
                    ...
                    <p className='text-center'>Phù hợp với những người có cuộc sống năng động, bận rộn, di chuyển nhiều.
