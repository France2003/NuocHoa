...
const MediaPage = () => {
  return (
    <div className="container_Brand w-full mt-44 m-auto flex flex-wrap ">
        ...
        <MediaProc img={img6} title="TOP 3 TINH DẦU NƯỚC HOA CODEDECO VỚI MÙI HƯƠNG SEXY" content="Codedeco sứ mệnh đem lại cho khách hàng những mùi hương quyến rũ và thanh lịch..."  />
