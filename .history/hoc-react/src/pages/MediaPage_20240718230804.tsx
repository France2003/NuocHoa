...
const MediaPage = () => {
  return (
    <div className="container_Brand w-[1210px] mt-36 mb-8 m-auto flex flex-wrap justify-between gap-5 ">
        ...
        <Link to={'/thuthuy'}><MediaProc img={img7} title="PHÂN BIỆT CÁC LOẠI NỒNG ĐỘ CỦA NƯỚC HOA" content="Nồng độ trong nước hoa xác định lượng phân tử hương thơm hòa tan trong cồn..."  /></Link>
