...
const ThanhPhuong = () => {
  return (
    <div className="mt-32 mb-5  w-[1120px]  flex justify-around flex-col  m-auto leading-7">
        ...
        <i>Bạn đang tìm kiếm bí quyết để ghi điểm ấn tượng trong mỗi lần gặp gỡ? Bạn muốn tạo ấn tượng khó phai, khiến người ấy nhớ mãi về bạn? Bí quyết nằm ngay trong những chai nước hoa <mark>CODEDECO</mark> - "Hương thơm gây thương nhớ" cho mọi buổi hẹn hò.</i>
    </div>
  )
}
