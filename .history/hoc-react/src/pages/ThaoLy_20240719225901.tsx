...
import img7II from '../../public/img/TLjpg.jpg'
const ThaoLy = () => {
  return (
    <div className="mt-32 mb-5  w-[1120px]  flex justify-around flex-col  m-auto leading-7">
      ...
      <div className='mx-9 mt-5 m'>
        ...
        <div className='flex w-[1250px] gap-2 items-center'>
          <img className='h-[500px] w-[800px]' src={img7II} alt="" />
          <div className='w-[450px] mx-2'>
            ...
            <div>
              ...
              <ul className='list-disc mx-5'>
                <li><b>Facebook:</b> <a style={{textDecorationLine:'underline'}} href="https://www.facebook.com/profile.php?id=61555159087139" target='_blank'>CODEDECO - SCENTS CODE FOR YOUR STYLE</a></li>
