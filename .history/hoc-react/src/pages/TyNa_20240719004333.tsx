...
const TyNa = () => {
    return (
        <div className='mt-32 mb-5 w-[1120px]  flex justify-around flex-col  m-auto leading-7 '>
            ...
            <div className='mx-9'>
                <p className='text-[18px] font-[500]'>1. Tinh dầu nước hoa Matcha Chilling Day</p>
                <img src={img4} className='w-[1050px] h-[450px] m-auto' alt="" />
                <p className='text-center italic'>Tinh dầu nước hoa là gì?</p>
                <p><b>Matcha Chilling Day</b> nằm trong top tinh dầu nước hoa được giới trẻ ưa chuộng với mùi hương dịu mát và tươi mới.
