    ...
    return (
        <div className='containerHome'>
            ...
            <div className='codedeco w-full flex items-center justify-around gap-[5px]'>
                ...
                <div className='w-[650px] flex flex-col leading-8 gap-2 '>
                    ...
                    <button className='ChiTiet flex items-center justify-center gap-21'> XEM CHI TIẾT <MdNavigateNext/> </button>
                </div>
            </div>
        </div>
    )
