...
const ThuyNi = () => {
    return (
        <div className="mt-32 mb-5  w-[1120px]  flex justify-around flex-col  m-auto leading-7">
            ...
            <p><mark>Codedeco </mark>sứ mệnh đem lại cho khách hàng những mùi hương quyến rũ và thanh lịch. 
            ...
            <div className='mx-9'>
                <p>1. TINH DẦU NƯỚC HOA CODEDECO SO SEXY BY NIGHT:</p>
                <img className='w-[1050px] h-[450px] m-auto' src={img6}  alt="" />
                <p className='text-center italic'>Tinh dầu nước hoa CODEDECO So Sexy By Night</p>
                <p>So Sexy By Night  là một sản phẩm lý tưởng cho phụ nữ muốn tăng thêm tự tin, quyến rũ và gợi cảm. 
