    ...
    return (
        <div className=" lienhe mt-32 mb-5   w-[1120px]  flex justify-around flex-col  m-auto leading-7">
            ...
            <div className="mx-9 mt-5">
                ...
                <input type="text" className="p-[5px] w-[250px]" placeholder="Tên của bạn" />
                <input type="tel" className="p-[5px] w-[250px]" placeholder="Số điện thoại" />
                <input type="email" className="p-[5px] w-[250px]" placeholder="email" />
                <input type="text" className="p-[5px] w-[250px]" placeholder="Nội dung chi tiết" />
            </div>
        </div>
    )
}
