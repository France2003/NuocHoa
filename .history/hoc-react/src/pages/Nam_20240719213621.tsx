...
const Nam = () => {
    return (
        <div className="mt-32">
            <h1 className="text-[#333] mx-9 text-[15px] uppercase font-[500] mx-9 tracking-wider mb-2">MÙI HƯƠNG CHO NAM </h1>
            <div className="flex mt-20 mb-8 justify-evenly mx-auto flex-wrap gap-y-24 w-[1390px] gap-[25px]">
                {nam.map((nam) => {
                    return (
