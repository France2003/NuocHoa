...
const LienHe = () => {
    return (
        <div className=" lienhe mt-32 mb-5   w-[1120px]  flex justify-around flex-col  m-auto leading-7">
            ...
            <div className="mx-9 mt-5 flex flex-col gap-4">
                <p className="font-[400] text-[18px]">Nhập thông tin của bạn vào Form dưới đây để được hỗ trợ tốt nhất.</p>
                <input type="text" className="p-[5px] w-[450px]" placeholder="Tên của bạn" />
                <input type="tel" className="p-[5px] w-[450px]" placeholder="Số điện thoại" />
                <input type="email" className="p-[5px] w-[450px]" placeholder="email" />
                <input type="text" className="p-[5px] w-[450px]" placeholder="Nội dung chi tiết" />
            </div>
        </div>
    )
}
