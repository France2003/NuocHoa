  ...
  return (
    <div className="mt-32 mb-5  w-[1120px]  flex justify-around flex-col  m-auto leading-7">
      ...
      <div className='mx-9 mt-5'>
        ...
        <p className='mt-2'>Tất cả các loại đều bắt đầu bằng chữ Eau, trong tiếng Pháp có nghĩa là “nước”, có 5 loại phổ biến sau:</p>
        <div className='flex w-[1200px] flex-wrap'>
          <img className='h-[450px] w-[550px]' src={img7II} alt="" />
          <img className='h-[450px] w-[530px] ml-[-20px]' src={img7III} alt="" />
          <img className='h-[450px] w-[505px] ml-[499.20px] mt-[-45px]' src={img7IIII} alt="" />
        </div>
      </div>
    </div>
  )
