    ...
    return (
        <div className='containerHome'>
            ...
            <div className='codedeco w-full flex items-center justify-around gap-[5px]'>
                ...
                <div className='w-[650px] flex flex-col leading-8 '>
                    <h2 className='text-center inline text-[27.36px] font-[900] text-[#383838]'>CODEDECO</h2>
                    <h3 className='text-center inline text-[21.28px font-[900] text-[#383838] tracking-wider'>CÂU CHUYỆN THƯƠNG HIỆU</h3>
