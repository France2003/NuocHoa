    ...
    return (
        <div className="mt-32 mb-5  w-[1120px]  flex justify-around flex-col  m-auto leading-7">
            ...
            <div className='mx-9'>
                ...
                {/*  */}
                <div>
                    <p className='mx-3 my-3 font-[400]' >1. Nước hoa CODEDECO ROSE BY CODE</p>
                ...
                {/*  */}
                <div>
                    <p className='mx-3 my-3' >2. Nước hoa CODEDECO VIE Merveilleuse</p>
                ...
                {/*  */}
                <div>
                    <p className='mx-3 my-3' >3. Nước hoa CODEDECO So Sexy By Night</p>
