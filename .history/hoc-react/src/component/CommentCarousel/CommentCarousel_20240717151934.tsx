    ...
    return (
        <div className="p-4">
            <div className="bg-white">
                <img style={{borderRadius:'50px'}} width={150} height={150} src={comments[currentCommentIndex].img} alt={comments[currentCommentIndex].name} />
                <div>
                    <p>{comments[currentCommentIndex].icon}</p>
