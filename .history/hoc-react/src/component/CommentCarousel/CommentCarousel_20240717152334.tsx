    ...
    return (
        <div className="p-4">
            <div className="bg-white flex">
                <img width={150} height={150} rounded-full src={comments[currentCommentIndex].img} alt={comments[currentCommentIndex].name} />
                <div>
                    <p className='flex'>{comments[currentCommentIndex].icon}
