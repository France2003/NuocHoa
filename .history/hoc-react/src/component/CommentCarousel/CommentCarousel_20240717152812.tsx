...
const CommentCarousel: React.FC = () => {
    ...
    return (
        <div className="p-4 w-[1200px] m-auto">
            <div className="bg-[#d80000] p-[40px] w-[1000px] flex items-center gap-8">
                ...
                <div>
                    ...
                    <i className='text-[18px]'>{comments[currentCommentIndex].content}</i>
                    <div>
