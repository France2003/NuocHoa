      ...
      <div className="flex justify-evenly mx-auto pt-7">
        ...
        <div className="w-[377px] h-[279px]">
          ...
          <div>
            ...
            <div>
              <img width={54} height={33} src="https://codedeco.art/wp-content/uploads/2023/11/ic-cash.svg" alt="" />
              <img width={54} height={33} src="https://codedeco.art/wp-content/uploads/2023/11/ic-internet-banking.svg" alt="" />
            </div>
            <img width={377} height={143} src="https://codedeco.art/wp-content/uploads/2023/07/logoSaleNoti.png" alt="" />
          </div>
        </div>
