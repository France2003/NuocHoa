...
const Footer = () => {
  return (
    <div className="containerFooter w-full bg-[#FAF9F5]  leading-6">
      <div className="flex justify-evenly mx-auto pt-7">
        <div className="FRAGRANCE w-[510px] leading-7">
          ...
          <div className="flex gap-2">
            <img src="https://codedeco.art/wp-content/uploads/2023/04/social-facebook-2019-circle-512-1-300x300.webp" alt="" />
            <img src="https://codedeco.art/wp-content/uploads/2023/04/instagram-512.webp" alt="" />
            <img src="https://codedeco.art/wp-content/uploads/2023/04/Shopee-Icon-Bulat-01-150x150.png" alt="" />
            <img src="https://codedeco.art/wp-content/uploads/2023/04/lazada-laz-round-icon-11662642367vewyj3oggn-150x150.png" alt="" />
            <img src="https://codedeco.art/wp-content/uploads/2023/04/a4582de5738fc57f5af111af897a7316-150x150.jpg" alt="" />
          </div>
        </div>
        {/*  */}
