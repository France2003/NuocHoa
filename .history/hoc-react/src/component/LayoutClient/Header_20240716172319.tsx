            ...
            <div className="Header">
                ...
                <div className="Menu w-full bg-black flex justify-evenly items-center p-[5px]">
                    ...
                    <div className="search flex items-center">
                        <input type="text" className="w-[180px] p-[4px] rounded-xl bg-[#353535] outline-none placeholder:text-[12px] placeholder:text-white placeholder:px-[3px]" placeholder="Tìm kiếm sản phẩm" /> 
