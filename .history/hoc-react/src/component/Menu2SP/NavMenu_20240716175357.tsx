...
const NavMenu: React.FC = () => {
  return (
    <div className="relative inline-block group">
      ...
      <ul className="navmenu ml-[-20px] mt-[12px] border-2 absolute w-[250px] text-black">
        <li className="bg-white hover:bg-slate-400 hover:text-white py-2 px-4 block whitespace-no-wrap flex gap-3">Phiên Bản Tết 2024</li>
